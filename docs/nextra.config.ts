  ...
  theme: {
    ...
    footer: {
      text: (
        <span>
          ...
          <a href="https://velvet.dev" target="_blank" rel="noreferrer">
            Velvet
          </a>
    ...
    editLink: {
      component: ({ children, filePath }) => (
        <a
          href={`https://github.com/velvet-ui/velvet/edit/main/docs/content/${filePath}`}
          target="_blank"
          rel="noreferrer"
        >
          {children}
