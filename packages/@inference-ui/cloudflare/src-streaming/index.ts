 ...
 */
export default {
  async fetch(request: Request, env: StreamingEnv, ctx: ExecutionContext): Promise<Response> {
      ...
      switch (path) {
        ...
        default:
          return createErrorResponse(
            `Not found: ${path}. Available endpoints: /chat, /completion, /object`,
            404
          );
      }
    } catch (error) {
...
} satisfies ExportedHandler<StreamingEnv>;
