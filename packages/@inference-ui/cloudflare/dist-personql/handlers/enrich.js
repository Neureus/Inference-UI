 ...
 */
export async function handleEnrich(request, env, ctx) {
    try {
        // Validate request
 ...
 */
async function getPersonData(person, env) {
 ...
 */
async function enrichProfile(person, options, env) {
 ...
 */
async function generateInsights(person, options, env) {
    const model = options?.model || '@cf/meta/llama-3.1-8b-instruct';
 ...
 */
async function generateRecommendations(person, options, env) {
    const model = options?.model || '@cf/meta/llama-3.1-8b-instruct';
 ...
 */
async function classifyPerson(person, options, _env) {
