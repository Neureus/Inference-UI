...
export class HybridAIRouter {
    constructor(config = {}) {
        ...
        this.config = {
            ...
            fallbackToEdge: true,
            modelCacheDir: '@inference-ui/models',
            ...config,
        };
    }
    /**
    ...
    async execute(task) {
        ...
        console.log(`[HybridAI] Routing ${task.type} to ${decision.target} (reason: ${decision.reason})`);
        let result;
 ...
 */
export async function routeAIRequest(task) {
